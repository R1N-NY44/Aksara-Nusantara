...
// Kuliner Section
// swiper for Kuliner Nusantara section
...
// swiper parameters
const KulinerNusantaraCarouselParams = new Swiper(".swiper1",{
      slidesPerView: 2.5,
      spaceBetween: 30,
      mousewheel: {
        invert: false,
...
// Kisah Inspiratif
// swiper for Kuliner Nusantara section
// const KisahInspiratifCarousel = document.getElementById('kisah-inspiratif')
// const KisahInspiratifCarouselNext = document.getElementsByClassName("swiper-button-next")
// const KisahInspiratifCarouselPrev = document.getElementsByClassName("swiper-button-prev")
// // swiper parameters
// const KisahInspiratifCarouselParams = {
//       slidesPerView: 1,
//       spaceBetween: 30,
//       mousewheel: {
//         invert: false,
...
// //Object.assign(KisahInspiratifCarousel, KisahInspiratifCarouselParams);
// // and now initialize it
// //KisahInspiratifCarousel.initialize();
...
//         const itemContentKisahInspiratif = document.createElement("swiper-slide");
//         itemContentKisahInspiratif.className = "item-kisah-inspiratif";
//         itemContentKisahInspiratif.classList.add("relative","h-96","rounded-xl","overflow-hidden","hover:h-[30rem]","group","transition-all","duration-300","w-96","ease-in-out")

//         const content = document.createElement("div");
//         content.classList.add("flex","flex-row","h-96","px-52","items-center","gap-x-10")
...
//         const image = document.createElement("img");
//         image.src = item.image
//         image.classList.add("h-96","w-[50rem]","rounded-2xl","object-cover")
...
//         fragmentKisahInspiratif.appendChild(itemContent)
//     })
//     KisahInspiratifCarousel.innerHTML = ""
//     KisahInspiratifCarousel.appendChild(fragmentKisahInspiratif)
// }
